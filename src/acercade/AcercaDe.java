...
public class AcercaDe extends JDialog {
    ...
    public AcercaDe(JFrame padre) {
        ...
        dirLogo = "iconos/paint_tux.png";
        nombrePrograma = "JDraw";
        descripcion = "<HTML>"
                + "Una aplicacion para hacer bocetos"
                + "<BR>"
                + "Hecho en Java"
                + "<BR>"
                + ""
        ...
        blog = "http://metalvegetarianoprogresivo.blogspot.com/2010/03/jdraw-tambien-se-puede-dibujar-en-java.html";
